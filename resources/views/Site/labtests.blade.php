...
<div class="breadcrumbs-area breadcrumb-bg ptb-50">
    <div class="container">
        <div class="breadcrumbs text-center">
            <h2 class="breadcrumb-title">Laboratory Services</h2>
            <ul>
                <li>
        ...
        <div class="row">
            <div class="col-md-12 mb-40">
              <div class="single-sidebar">
                   <form action="{{route('labtestSearch')}}" method="get">
                      @csrf
                                        ...
                                        <div class="col-md-4 col-lg-3 col-sm-12">
                                          <div class="single-shop mb-40">
                                              <div class="shop-img text-center centered">
                                                  <a ><img src="{{URL::asset('ProductImages/labtest.png')}}" alt="" style="margin-top:40px;"/></a>
                                                  ...
                                                  <div class="button-group">
                                                      <a href='' title="Add to Cart" class="text-center" onclick="addToCart({{$prod->id}}, 'Service');return false;">
                                              ...
                                              <div class="single-shop mb-40">
                                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                                      <div class="text-center">
                                                          <div class="shop-img text-center centered">
                                                              <a><img src="{{URL::asset('ProductImages/labtest.png')}}" alt="" /></a>
                                                              @if ($prod->onSale==1)
                                                                <div class="price-up-down">
                                                                    <span class="sale-new">sale</span>
                                                                </div>
