            ...
            <div class="container-fluid">
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        <li class="has-submenu"><a href="{{ route('managerPortal.home') }}"><i class="ti-dashboard"></i> <span>Dashboard</span></a></li>
                        <li class="has-submenu"><a href="{{ route('managerPortal.products') }}"><i class="ti-dashboard"></i> <span>Products</span></a></li>
